...
[
  {
    ...
    "summary_vn": "Viết caption Instagram tiếng Việt 2-3 câu NGẮN GỌN: mô tả điểm nổi bật, kết bằng CTA (ví dụ: 'Save lại khi cần nha!', 'Tag bạn bè cùng khám phá!', 'Ai đã thử chưa?'). KHÔNG thêm hashtag vào đây — hashtag sẽ được thêm riêng.",
    "hashtags_vn": "5-8 hashtag tiếng Việt liên quan, BẮT BUỘC có #NhaTrang #KhanhHoa. Ví dụ: #NhaTrang #KhanhHoa #AmThuc #QuanNgon #NhaTrangFood",
    "summary_en": "Write Instagram caption in English 1-2 SHORT sentences: highlight key point, end with CTA (e.g. 'Save for your trip!', 'Tag someone!'). Do NOT include hashtags here.",
    "hashtags_en": "5-8 English hashtags, MUST include #NhaTrang #Vietnam #Travel. Example: #NhaTrang #Vietnam #Travel #FoodieVietnam",
